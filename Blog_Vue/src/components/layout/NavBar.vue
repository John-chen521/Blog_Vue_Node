<template>
  ...
  <div>
    ...
    <el-header :style="'margin-bottom:'+ headerBottom +'px'" class="animate__animated animate__fadeIn">
      <h2 class="animate__animated animate__swing logo" :key="shade" @click="shade++">Alex Chen</h2>
      <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" background-color="rgba(0,0,0,0)"
        style="border: none;" router text-color="#fff" active-text-color="#ffd04b">
      ...
      <div class="search_input">
        <el-input @focus="checkInput" @blur="notSearching()" class="search" placeholder="请输入内容"
